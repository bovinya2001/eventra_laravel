...
<head>
    ...
    <title>{{ config('app.name', 'Eventra') }} - Login</title>
...
<body>
    <div class="wrapper">
        ...
        <div class="tab-toggle">
            <a href="{{ route('login') }}" class="tab-btn active">Login</a>
            <a href="{{ route('register') }}" class="tab-btn">Register</a>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-sub">Login to your account to continue</div>
