<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto px-6 space-y-8">
            ...
            <!-- Welcome Banner -->
            <div class="relative overflow-hidden bg-gradient-to-r from-indigo-900/80 to-purple-900/80 border border-indigo-500/30 rounded-2xl p-8">
                <div class="absolute top-0 right-0 w-64 h-64 bg-indigo-600 rounded-full filter blur-[80px] opacity-20"></div>
                <div class="relative">
                    <p class="text-indigo-300 text-sm font-medium mb-1">Welcome back,</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="bg-slate-800/50 border border-white/10 rounded-2xl p-6">
                    <div class="w-10 h-10 bg-{{ $stat['color'] }}-600/20 rounded-xl flex items-center justify-center mb-4">
            ...
            <div class="bg-slate-800/50 border border-white/10 rounded-2xl p-6">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-lg font-semibold text-white">My Registered Events</h2>
                    <a href="{{ route('my.events') }}" class="text-indigo-400 hover:text-indigo-300 text-sm transition-colors">
                        View all →
                    </a>
                </div>
                ...
                <div class="text-center py-12">
                    ...
                    <a href="{{ route('events.index') }}"
                        class="inline-block mt-4 bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-medium px-5 py-2.5 rounded-xl transition-colors">
                        Browse Events
                    </a>
                </div>
                @else
            ...
            <!-- Browse More Events -->
            <div class="bg-gradient-to-r from-indigo-900/40 to-purple-900/40 border border-indigo-500/20 rounded-2xl p-6 flex items-center justify-between">
                <div>
                ...
                <a href="{{ route('events.index') }}"
                    class="bg-indigo-600 hover:bg-indigo-500 text-white font-medium px-5 py-2.5 rounded-xl transition-all hover:shadow-[0_0_20px_rgba(99,102,241,0.4)] whitespace-nowrap">
                    Browse Events →
                </a>
            </div>
